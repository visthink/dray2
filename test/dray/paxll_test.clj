...
(deftest bioentity-names-test
  (testing "Bioentity names test"
    (let [bioentity-name-variants (private-function bioentity-name-variants dray.paxll)]
...
(deftest split-out-subnames-test
  (testing "Splitting out subnames in a composite name."
    (let [split-out-subnames (private-function split-out-subnames dray.paxll)]
...
(deftest test-patternbox-pattern
  (testing "Test the expansion of patternbox patterns."
    (let [pattern? (private-function pattern? dray.paxll)
          xpattern? (private-function xpattern? dray.paxll)
          expand-patternbox-pattern (private-function expand-patternbox-pattern dray.paxll)
...
(deftest test-bioentity-class
  (testing "Test the bioentity-class function call, especially classname variants."
    (let [bioentity-class (private-function bioentity-class dray.paxll)]
...
(deftest test-make-patterns 
  (testing "Test just making a few patterns."
    (let [xpattern? (private-function xpattern? dray.paxll)]
