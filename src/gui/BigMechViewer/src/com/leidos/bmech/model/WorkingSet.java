...
//	private BufferedImage image;
	...
	/**
	 * Creates a new working set and adds the items inside of
	 * rect from the parent into the child.
	 * @param name The name of the working set
	 * @param rect The bounding box of items to add to the new WS
	...
	/**
	 * takes a working set and adds it to the calling workingset as a child. 
	 * If there already is a child that has the same dimensions, 
	 * then it merges the children together
	 * @param added the WorkingSet to merge
	...
	/**
	 * test whether two working sets are equal, based solely on size and pdf origin
	 * @param obj the working set to compare to
	 * @return
	 */
	...
	/**
	 * test to see if the param WorkingSet is among the ancestors of this workingset
					...
					if (sibling != child){
						...
						if(child.getBbox().contains(sibling.getBbox())){
							...
							//	System.out.println("moving "+sibling +" into "+child);
								...
								System.out.println(this.getChildren());
							} else System.out.println(child+ " is already there");
							shuffled = true;
	...
	public Color getColor() {
    	...
    	} else 	return new Color(25, 25, 112);
	...
	public boolean equals(Object obj){
		if(obj instanceof WorkingSet){
			...
			//compare items
			return this.getItems().equals(objWS.getItems()) &&
					this.getTags().equals(objWS.getTags());
