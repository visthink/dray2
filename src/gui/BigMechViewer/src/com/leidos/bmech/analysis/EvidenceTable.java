...
/**
 * EvidenceTable: A mapping of an object such as a column or a cell to a list of
 * evidence. Essentially just a hashmap with additional functions
 * 
 * @author powelldan
 *
 */
...
public class EvidenceTable extends HashMap<Object, List<Evidence>> {
	 ...
	 * @param belief
	 */
	public void addEvidence(Object entity, String classification, Object support, Double belief) {
	...
	/**
	 * Gets the strength of the highest strength evidence for a given
	 * classification
	 * 
	 * @param entity
	 *           the object(i.e. column or cell) to search evidence of
	 * @param classification
	 *           the classification to search for evidence of
