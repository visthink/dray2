...
/**
 * Evidence -- representation of a piece of evidence consists of: belief: how
 * strong this piece of evidence is support: what this evidence is supported by.
 * usually a string, but represented as an Object classification: what this
 * evidence says about the object (i.e. PROTEIN)
 * 
 * @author powelldan
 *
 */
public class Evidence extends HashMap<String, Object> implements Comparable<Object> {
	...
	/**
	 * Returns an object representing the support for the given evidence. Often,
	 * but not always, a String value.
	 * 
	...
	/**
	 * Returns true if the evidence represents a composite or group object.
	 * 
	...
	/**
	 * Set the part of the represented object. For example, if this evidence
	 * represents a column, the parts contain the cells. Evidence for these cells
	 * would then need to be retrieved from the containing evidence table.
	 * 
	 * @param objs
	 *           a list of objects
	 */
	...
	/**
	 * Return the parts of the represented object. Returns nil if there are no
	 * parts.
	 * 
