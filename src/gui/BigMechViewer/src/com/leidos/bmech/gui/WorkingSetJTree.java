...
public class WorkingSetJTree extends JTree {
  ...
  public void reload() {
    ...
    // DefaultMutableTreeNode wsHead =
    // (DefaultMutableTreeNode)workingSetTree.getModel().getRoot();
  ...
  public void refresh() {
    ...
    // this.expandPath(new
    // TreePath(((DefaultMutableTreeNode)theNode.getParent()).getPath()));
  ...
  public void insertWorkingSetNode(WorkingSet parent, WorkingSet ws) {
    ...
    // workingSetTree.getLastSelectedPathComponent();
  ...
  private WorkingSet getWSFromPath(TreePath path) {
    ...
    Enumeration e = ((DefaultMutableTreeNode) this.getModel().getRoot()).depthFirstEnumeration(); e
        .hasMoreElements();) {
  ...
  class MyTreeModelListener implements TreeModelListener {
    public void treeNodesChanged(TreeModelEvent e) {
       ...
       * node we have already gotten. Otherwise, the changed node and the
