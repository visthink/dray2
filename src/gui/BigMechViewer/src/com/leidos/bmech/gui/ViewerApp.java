...
public class ViewerApp implements Observer, ActionListener {
  ...
  private void initialize() {
     ...
     * layerCheckList.locationToIndex(e.getPoint()); if (index != currentIndex){
     * //dataManager.getLayerList().getLayerByIndex(index).setShouldHighlight(
     * true); canvas.repaint(); currentIndex = index; } } });
     */
    /*
     ...
     * File("resources/corpora/wnt-pv/008_11_pv.pdf")); workingSetTree.reload();
     * refreshPageIconList(); this.refreshLayerList();
