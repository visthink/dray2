...
/**
 * DataManagerView -- this class is responsible for maintaining the current
 * state of user interaction with the DataManager, such as which working set is
 * being worked on, and which elements are selected
 * 
 * @author powelldan
 *
 */
