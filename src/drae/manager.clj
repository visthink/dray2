(ns drae.manager
  "Support for the DataManager, WorkingSet, Layer and LayerList classes in DRAE.
   Working set functions begin with *ws-*, and data manager functions begin with *dm-*."
  (:import (java.util ArrayList)
           (drae.j.VisualElement VImage VDocument)
...
(defmethod make-data-manager drae.j.VisualElement.VDocument [vdoc]
...
(defn- visual-el? [x] (instance? drae.j.VisualElement.El x))
