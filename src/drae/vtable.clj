(ns drae.vtable
  ...
  (:require [clojure.java.io :refer [file]]
            ...
            [drae.doc :refer [bbox-union sort-vertically sort-horizontally
                              common-text-style get-vdocument]]
            [drae.wset :refer [ws-items ws-descendants]]
...
(defmethod print-method drae.j.VisualElement.VTable 
  [vt writer]
  (.write writer 
...
(defn vtable? "Is this an instance of VTable?" 
  [x] (instance? drae.j.VisualElement.VTable x))
